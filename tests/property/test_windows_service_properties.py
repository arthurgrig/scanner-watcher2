...
@patch("scanner_watcher2.service.windows_service.win32evtlogutil")
@patch("scanner_watcher2.service.windows_service.win32event")
def test_service_start_logging(
    mock_win32event, mock_win32evtlogutil, service_name, temp_config_dir, temp_log_dir, mock_config
):
    """
    ...
    **Validates: Requirements 4.4, 7.5**
    ...
    mock_win32evtlogutil.ReportEvent = mock_report_event
...
def test_critical_error_logging(
    mock_win32event, mock_win32evtlogutil, error_message, temp_config_dir, temp_log_dir
):
    """
